  ...
  <transition name="showAbout">
    <div class="about">
      ...
      <div class="about-content">
        ...
        <p class="url"><b>源码地址</b>：<a @touchstart="isHover=true" @touchEnd="isHover=false" :class="{hover: isHover}" href="https://github.com/geekape/vue-cnode" target="_blank">GitHub</a></p>
        <p class="url"><b>个人网站</b>：<a @touchstart="isHover=true" @touchEnd="isHover=false" :class="{hover: isHover}" href="http://www.zcbboke.com" target="_blank">www.zcbboke.com</a></p>
        <p><br>&nbsp;&nbsp;&nbsp;待业码农，求工作～～</p>
        
        <p class="copyright"><b>【声明】</b>：本项目仅供学习交流使用，请不要用作任何商业用途。有任何疑问请联系作者↓ <br>📩：<a href="mailto:861013016@qq.com">861013016@qq.com</a></p>
      </div>
